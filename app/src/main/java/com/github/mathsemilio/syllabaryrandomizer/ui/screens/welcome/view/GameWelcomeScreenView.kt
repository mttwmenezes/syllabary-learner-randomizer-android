...
abstract class GameWelcomeScreenView : BaseObservableView<GameWelcomeScreenView.Listener>() {

    interface Listener {
        fun onSettingsIconClicked()

        fun onDifficultyOptionSelected(difficulty: GameDifficulty)
    ...
    abstract fun bindDefaultDifficultyValue(defaultDifficultyValue: String)
}
