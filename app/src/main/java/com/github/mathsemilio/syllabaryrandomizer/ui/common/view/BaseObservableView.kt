...
import com.github.mathsemilio.syllabaryrandomizer.common.observable.Observable

abstract class BaseObservableView<T> : BaseView(), Observable<T> {
    ...
    protected inline fun BaseObservableView<T>.notify(
        crossinline notificationBody: (T) -> Unit
    ) {
